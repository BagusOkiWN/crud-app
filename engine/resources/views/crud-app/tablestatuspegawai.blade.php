              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $statuspegawai->status_pegawai }}</td>
                    <td>
                      <a href="{{ route('crud-app.editstatuspegawai', $statuspegawai->id) }}" class="btn btn-warning">Edit</a>
                      <form 
                      onsubmit="return confirm('Apakah anda yakin?')" 
                      action="{{ route('crud-app.destroystatuspegawai', $statuspegawai->id) }}" 
                      method="post"
